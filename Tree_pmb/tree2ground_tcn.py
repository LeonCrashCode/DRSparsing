...
parser.add_argument("--type", default="exp", help="exp | span | span_index"
parser.add_argument("--connect", default='~', help="it connects two spans, default is ~")
